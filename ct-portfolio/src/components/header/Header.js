...
const Header = () => {
    ...
    return (
        <header className="bg-gray-910 relative pb-2 sm:pb-10 md:pt-20 md:pb-40">
            ...
            <div className=" mt-8 text-right bottom-0 right-0 pr-4 md:pr-4 md:absolute  sm:text-center">
                <h2 className="text-lg text-orange-920  sm:text-2xl lg:text-4xl md:pr-24 sm:mr-16 font-syncopate font-thin" >Personal Portfolio</h2>
            </div>
        </header>
    )
